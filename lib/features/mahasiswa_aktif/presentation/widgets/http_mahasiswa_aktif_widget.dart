...
class _ModernMahasiswaAktifCardState extends State<ModernMahasiswaAktifCard>
  ...
  Widget build(BuildContext context) {
    // Menggunakan gradient dari parameter atau warna tema default
      ...
      child: ScaleTransition(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                // Avatar Box menggunakan ID dari Post
                Container(
                  width: 60,
                  height: 60,
                  decoration: BoxDecoration(
                ...
                // Informasi Konten (Title dan Body dari API Posts)
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Menampilkan ID User sebagai info tambahan
                      _buildInfoRow(Icons.person_outline, 'User ID: ${widget.mahasiswa.userId}'),
                      const SizedBox(height: 4),
                      // Menampilkan cuplikan isi post (body)
                      _buildInfoRow(Icons.description_outlined, widget.mahasiswa.body),
                    ],
                  ),
                ),
                Container(
